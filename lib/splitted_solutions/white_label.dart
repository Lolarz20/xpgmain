                          ...
                          children: [
                            Stack(
                              children: [
                                Image(
                                    image: NetworkImage(
                                        'https://firebasestorage.googleapis.com/v0/b/a-lunch-e6ccd.firebasestorage.app/o/casinoAll%2FCasino%20-360%20(1).jpg?alt=media&token=a138ff23-3014-4866-9086-b9a758c3b814'),
                                    width: width,
                                    height: height * 0.8,
                                    fit: BoxFit.cover),
                                FadeInUp(
                            ...
                            Stack(
                              children: [
                                ...
                                FadeInUp(
                                  ...
                                  child: Padding(
                                      padding:
                                          EdgeInsets.only(top: 300, left: 25),
                                      child: Column(
                                        crossAxisAlignment:
                                            CrossAxisAlignment.start,
                                        children: [
