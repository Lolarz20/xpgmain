            ...
            children: [
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                SizedBox(
                                  width: width * 0.2,
                                  child: Text('Integration time: 2-3 months.',
                                      style: TextStyle(
                                          color: Colors.grey,
                                          fontFamily: 'pop2')),
                                )
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                SizedBox(
                                  width: width * 0.2,
                                  child: Text('Integration time: 1-2 weeks.',
                                      style: TextStyle(
                                          color: Colors.grey,
                                          fontFamily: 'pop2')),
                                )
                ...
                child: Column(
                  children: [
                    Text(
                        ...
                        style:
                            TextStyle(fontFamily: 'pop2', color: Colors.grey)),
                    SizedBox(height: height * 0.01),
                    Text(
                        textAlign: TextAlign.center,
              ...
              SizedBox(
                ...
                child: Text(
                    ...
                    style: TextStyle(fontFamily: 'pop2', color: Colors.grey)),
              ),
              SizedBox(height: height * 0.05),
              Center(
                child: Padding(
                                      ...
                                      Row(
                                        children: [
                                          Icon(Icons.check_box_outlined,
                                              color: Colors.orange),
                                          SizedBox(width: width * 0.01),
                                          Text('Change table watermark in UI',
                                              style: TextStyle(
                                                  color: Colors.grey,
                                                  fontFamily: 'pop2'))
                                        ],
                            ...
                            SizedBox(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: Image(
                                    ...
                                    image: NetworkImage(
                                        'https://firebasestorage.googleapis.com/v0/b/a-lunch-e6ccd.firebasestorage.app/o/ROULETTE1-ezgif.com-video-to-gif-converter.gif?alt=media&token=ce958e52-0f8f-4b53-9365-73fa919311cf'),
                                  ),
                                )
                                //child: playerWidget),
                                ),
