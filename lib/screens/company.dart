          ...
          children: [
            ...
            Row(
              ...
              children: [
                Column(
                  children: [
                    Icon(Icons.open_in_full, color: Colors.blue, size: 50),
                    SizedBox(height: 15),
                    SizedBox(
                      width: width * 0.15,
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              SizedBox(
                                width: width * 0.2,
                                child: Text('Relaxed and friendly atmosphere',
                                    style: TextStyle(
                                        color: Colors.grey,
                                        fontFamily: 'pop2')),
                              )
                ...
                Container(
                  ...
                  child: Padding(
                      ...
                      child: Center(
                        child: Row(
                          children: [
                            Icon(Icons.code, color: Colors.blue, size: 35),
                            SizedBox(width: width * 0.01),
                ...
                Container(
                  ...
                  child: Padding(
                      ...
                      child: Center(
                        child: Row(
                          children: [
                            Icon(Icons.woman, color: Colors.indigo, size: 35),
                            SizedBox(width: width * 0.01),
                      ...
                      children: [
                        Text('01',
                            style: TextStyle(
                                ...
                                fontSize: 25)),
                        SizedBox(width: width * 0.05),
                        Text('Anti-Fraud and Anti-Money Laundering Policy ',
                            style: TextStyle(
